...
<template>
  <div class="shop-page bg-gray-50 min-h-screen pb-20 relative">
    <!-- Header -->
    <div class="block lg:hidden bg-white border-b border-gray-200 py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 flex flex-col md:flex-row gap-8 items-start">
      ...
      <div class="hidden lg:block bg-white border-b border-gray-200 py-8 px-4 sm:px-6 lg:px-8 mb-5">
        ...
        <div v-if="viewMode === 'grid'" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div class="h-[250px] w-full bg-gray-50 flex items-center justify-center p-6 relative overflow-hidden shrink-0 border-b border-gray-50">
